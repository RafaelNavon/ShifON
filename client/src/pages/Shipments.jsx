...
export default function Shipments() {
  ...
  const thisWeek = shipments.filter(
    (s) => new Date(s.shipment_date) >= weekStart,
  );
        ...
        <div className="ship-table-wrap">
          {shipments.length === 0 ? (
            ...
            <table className="ship-table">
              ...
              <tbody>
                {shipments.map((s) => {
                  const totalStraws = (s.items || []).reduce(
                  ...
                  return (
                    <Fragment key={s.id}>
                      <tr
                        ...
                        <td>
                          <span
                            className={`dest-badge ${DEST_CLASS[s.destination] || ""}`}>
                                  ...
                                  {deleteConfirmId === s.id ? (
                                    <div className="delete-confirm">
                                      <span className="delete-confirm-text">
                                        Delete this shipment record? This cannot
                                        be undone.
                                      </span>
                                      {deleteError && (
                    ...
                    <div className="ship-item-fields">
                      <div className="mfield">
                        ...
                        <select
                          value={item.bull_id}
                          onChange={(e) =>
                            setItem(i, "bull_id", e.target.value)
                          }
                          required>
                      ...
                      <div className="mfield">
                        ...
                        <select
                          value={item.batch_id}
                          onChange={(e) =>
                            setItem(i, "batch_id", e.target.value)
                          }
                          required
